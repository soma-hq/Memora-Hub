...
const TIPS: Tip[] = [
	...
	},
	{
		...
		points: [
			"Les demandes de deblocage passent par un Google Form externe.",
	...
	{
		title: "Chat en direct (spam, insultes, flood)",
		icon: "video",
...
// Page
/**
 * YouTube moderation tips page with best practices and special case procedures.
 * @returns The YouTube tips and guidelines reference page
 */
export default function TipsYouTubePage() {
	return (
		<PageContainer title="Tips" description="Conseils et procedures pour les situations courantes sur YouTube">
			{/* Intro banner */}
