...
const PAGE_CONFIG = definePageConfig({
	name: "hub/[groupId]/moderation/centre-info/tickets",
	section: "protected",
	module: "moderation_discord",
	description: "Gestion des tickets Discord.",
	requiredPermissions: [{ module: "moderation_discord", action: "view" }],
	entityScoped: true,
});

/**
 * Tickets system page explaining moderation ticket procedures.
 * @returns The ticket system documentation page
 */
export default function TicketsPage() {
	return (
		<PageContainer title="Systeme de Tickets" description="Procedure et fonctionnement du systeme de tickets">
			{/* Important notice */}
			...
			<div className="space-y-6">
				...
				<Card className="border-l-primary-500 border-l-4" padding="lg">
					...
					<p className={cn(textClasses.body, "leading-relaxed")}>
						Les tickets constituent le canal officiel pour toute communication avec les membres. Qu&apos;il
						s&apos;agisse d&apos;une demande, d&apos;une contestation ou d&apos;une question, les membres
						doivent etre rediriges vers le systeme de tickets.
					</p>
				</Card>
				...
				<Card className="border-l-error-500 border-l-4" padding="lg">
					...
					<p className={cn(textClasses.body, "leading-relaxed")}>
						Il est formellement interdit de traiter des cas de moderation par messages prives. Cela protege
						a la fois le moderateur et le membre, en garantissant une tracabilite et une transparence totale
						des echanges.
					</p>
				</Card>
				...
				<Card className="border-l-info-500 border-l-4" padding="lg">
					...
					<p className={cn(textClasses.body, "mb-3 leading-relaxed")}>
						Lorsqu&apos;un membre vous contacte en prive pour un sujet lie à la moderation, redirigez-le
