...
const DEMO_ALERTS: SystemAlert[] = [
	{
		id: "alert-001",
		type: "update",
		title: "Mise à jour de la page Projets",
		description: "La page Projets à ete mise à jour avec un nouveau systeme de creation par modals successifs.",
	...
	},
	{
		...
		description: "Un utilisateur à tente d'acceder à la page Admin sans les permissions requises.",
	...
	},
	{
		id: "alert-003",
		type: "access_granted",
		title: "Accès autorise",
		description: "Votre demande d'accès à la page Moderation à ete approuvee.",
