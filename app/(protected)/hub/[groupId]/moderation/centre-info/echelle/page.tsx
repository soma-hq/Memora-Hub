...
const PAGE_CONFIG = definePageConfig({
	name: "hub/[groupId]/moderation/centre-info/echelle",
	section: "protected",
	module: "moderation_discord",
	description: "Échelle de priorité de la modération Discord.",
...
const HIERARCHY: HierarchyLevel[] = [
	...
	},
	{
		...
		members: [
			{ name: "Procy", role: "Responsable de Live" },
			{ name: "Andrew", role: "Responsable de Live" },
		],
	},
	{
		title: "Coordinateurs",
...
/**
 * Priority scale page displaying the moderation chain of command.
 * @returns The hierarchy and priority levels view
 */
export default function EchellePage() {
	return (
		<PageContainer title="Echelle de priorite" description="Chaine de commandement pour les actions de moderation">
			{/* Intro banner */}
