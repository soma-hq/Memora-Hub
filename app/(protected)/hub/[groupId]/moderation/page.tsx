...
const LIVECON_LEVELS: LiveconConfig[] = [
	{
		...
		consignes: [
			...
			"Gestion habituelle des conflits entre membres.",
			"Les moderateurs suivent la procedure classique pour les infractions.",
			"Les membres de l'equipe peuvent apparaitre normalement sur le serveur.",
	...
	},
	{
		...
		consignes: [
			...
			"Interdiction totale d'apparition de l'equipe de moderation sur le serveur.",
			"Les discussions liees au drama sont immediatement supprimees.",
...
/**
 * Moderation panel page with Livecon vigilance level system.
 * @returns The Livecon level management dashboard
 */
export default function ModerationPanelPage() {
	...
	return (
		<PageContainer title="Panel" description="Systeme Livecon — Niveaux de vigilance">
