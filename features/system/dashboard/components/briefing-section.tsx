...
export function BriefingSection({ greeting, subtitle, items }: BriefingSectionProps) {
	...
	const headerBanner =
		palette.mode === "owner"
			? "/banners/boxes/titles/title-banner4.png"
			: palette.mode === "legacy"
				? "/banners/boxes/titles/title-banner2.png"
				: "/banners/boxes/titles/title-banner3.png";
	...
	return (
		<div className="space-y-6">
			...
			>
				...
				/>
				<div className="pointer-events-none absolute inset-0 bg-white/65 dark:bg-slate-900/55" />
