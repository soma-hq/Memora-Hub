...
const PAGE_CONTEXT_MAP: Record<string, { module: string; label: string }> = {
	...
	"/tasks": { module: "task", label: "Tâches" },
	"/meetings": { module: "meeting", label: "Réunions" },
	...
	switch (module.module) {
		case "dashboard":
			suggestions.push(
				{
					id: "ctx-recent-tasks",
					label: "Tâches recentes",
					icon: "tasks",
					description: "Voir les dernieres tâches",
				...
				},
				{
					...
					icon: "calendar",
					description: "Réunions à venir",
					query: "Quelles sont mes prochaines réunions ?",
					category: "meeting",
				},
				{
					id: "ctx-create-task",
					...
					icon: "plus",
					description: "Creer une tâche rapidement",
		...
		case "project":
			suggestions.push(
				...
				},
				{
					...
					query: "Montre-moi les tâches de ce projet",
					category: "task",
				},
				{
		...
		case "task":
			suggestions.push(
				...
				},
				{
					...
					label: "Mes tâches",
					icon: "tasks",
					description: "Mes tâches assignees",
				...
				},
				{
					...
					query: "Quelles tâches sont en retard ?",
					category: "task",
				},
				{
		...
		case "meeting":
			suggestions.push(
				...
				},
				{
					...
					label: "Annuler",
					icon: "close",
					description: "Annuler une réunion",
					query: "Annuler la réunion ",
					category: "meeting",
				},
			);
			break;
		...
		case "absence":
			suggestions.push(
				...
				},
				{
					...
					label: "En attente",
					icon: "warning",
					description: "Absences à valider",
