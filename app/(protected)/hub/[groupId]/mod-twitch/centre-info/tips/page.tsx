...
const TIPS: Tip[] = [
	...
	},
	{
		...
		points: [
			...
			"Si un viewer demande un traitement plus rapide : refuser poliment.",
	...
	},
	{
		...
		points: [
			"Creer une note avec les elements suspects observes (messages, comportements, liens dans le chat).",
...
export default function TwitchTipsPage() {
	return (
		<PageContainer title="Tips" description="Conseils et procedures pour les situations courantes sur Twitch">
			{/* Intro banner */}
