...
export async function GET(request: NextRequest) {
	...
	const result = await ProjectService.getByGroup(resolvedGroupId, page, pageSize);
...
export async function POST(request: NextRequest) {
	...
	const project = await ProjectService.create(resolvedGroupId, currentUser.id, parsed.data);
