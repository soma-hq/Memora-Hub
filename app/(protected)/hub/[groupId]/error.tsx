...
/**
 * Error boundary for the hub group pages.
...
export default function HubError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
	...
	return (
		<div className="flex h-full min-h-[60vh] flex-col items-center justify-center gap-4 px-4">
			...
			<h2 className="text-lg font-semibold text-gray-900 dark:text-white">Une erreur est survenue</h2>
			<p className="max-w-md text-center text-sm text-gray-500 dark:text-gray-400">
				Le chargement de la page a echoue. Veuillez reessayer.
			</p>
			<button
				onClick={reset}
