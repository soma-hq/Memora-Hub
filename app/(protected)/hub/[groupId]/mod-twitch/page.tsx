...
/**
 * Twitch moderation panel page with Livecon vigilance level system.
 * @returns The Livecon level management dashboard for Twitch
 */
export default function ModTwitchPanelPage() {
